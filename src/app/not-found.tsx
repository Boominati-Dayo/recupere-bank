      ...
      <div className="min-h-screen bg-navy-900 flex items-center justify-center p-4 relative overflow-hidden">
        ...
        <div className="max-w-2xl w-full text-center relative z-10">
          <div className="inline-flex items-center justify-center w-24 h-24 rounded-full bg-navy-800 border border-navy-700 mb-8 shadow-2xl relative">
            ...
            <div className="absolute -bottom-2 -right-2 w-8 h-8 rounded-full bg-primary-500 flex items-center justify-center border-4 border-navy-900">
          ...
          <h2 className="text-2xl md:text-3xl font-bold text-primary-400 mb-6 font-serif">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <Link
              href="/contact"
              className="flex items-center justify-center gap-2 bg-primary-500 hover:bg-primary-400 text-navy-900 font-bold px-8 py-4 rounded-lg transition-transform hover:-translate-y-1 w-full sm:w-auto shadow-lg shadow-primary-500/20"
            >
              Report a Scam
            </Link>
          </div>
