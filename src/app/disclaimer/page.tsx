          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              <div className="prose prose-lg max-w-none text-gray-700">
                ...
                <p className="mb-6">
                  Asset recovery is a complex process involving cross-border legal and financial protocols. Success is not guaranteed and depends on various factors, including the nature of the scam, the jurisdiction of the funds, and the cooperation of external financial institutions. Past recovery successes do not guarantee future results. All recovery services are subject to applicable international laws and regulations in the relevant jurisdictions.
                </p>

                <h2 className="text-2xl font-bold text-navy-900 mb-6 font-playfair">3. Limitation of Liability</h2>
                <p className="mb-6">
                  Under no circumstance shall we have any liability to you for any loss or damage of any kind incurred as a result of the use of the site or reliance on any information provided on the site. Your use of the site and your reliance on any information on the site is solely at your own risk. To the extent permitted by applicable law, all liability is excluded.
                </p>
                ...
                <div className="mt-12 p-6 bg-navy-50 rounded-lg border border-primary-200">
                  <p className="text-navy-900 font-medium italic">
                    By using this website and our services, you acknowledge that you have read and understood this legal disclaimer. For further information, please contact our legal team through the <Link href="/contact" className="text-primary-600 underline hover:text-primary-700 transition-colors">contact page</Link>.
                  </p>
                </div>
              </div>
            </motion.div>
