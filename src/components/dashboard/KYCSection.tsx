        ...
        return (
            <div className="flex flex-col items-center justify-center py-12 text-center">
                ...
                <button 
                    ...
                    className="px-8 py-3 bg-navy-900 text-primary-500 rounded-xl font-bold transition-all hover:bg-navy-800"
                >
                    Resubmit Documents
                </button>
            </div>
            ...
            <div className="flex items-center justify-between mb-12 relative">
                ...
                {[1, 2, 3].map((s) => (
                    <div key={s} className="relative z-10 flex flex-col items-center">
                        <div className={`w-10 h-10 rounded-full flex items-center justify-center font-bold transition-all ${step >= s ? 'bg-primary-500 text-[#0b1626]' : 'bg-white border-2 border-gray-200 text-gray-400'}`}>
                        ...
                        <div className="border-2 border-dashed border-gray-300 rounded-2xl p-8 text-center bg-white">
                            {idFront ? (
                                ...
                                <label className="cursor-pointer block">
                                    ...
                                    <p className="text-gray-400 text-sm mt-1">PNG, JPG or WEBP (Max 15MB)</p>
                                </label>
                            )}
                        </div>
                        <div className="mt-8 flex justify-end">
                            <button onClick={() => setStep(2)} disabled={!idFront} className="px-8 py-3 bg-navy-900 text-primary-500 rounded-xl font-bold disabled:opacity-50">Next Step</button>
                        </div>
                    </motion.div>
                )}
                ...
                {step === 2 && (
                    <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }}>
                        ...
                        <div className="mt-8 flex justify-between">
                            ...
                            <button onClick={() => setStep(3)} disabled={!idBack} className="px-8 py-3 bg-navy-900 text-primary-500 rounded-xl font-bold disabled:opacity-50">Next Step</button>
                        </div>
                    </motion.div>
                )}
                ...
                {step === 3 && (
                    <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }}>
                        ...
                        <div className="mt-8 flex justify-between">
                            ...
                            <button onClick={handleSubmit} disabled={!selfie || isSubmitting} className="px-8 py-3 bg-primary-500 text-[#0b1626] rounded-xl font-bold disabled:opacity-50 flex items-center">
