...
const ResetPasswordTokenPage = ({ params }: ResetPasswordTokenPageProps) => {
    ...
    return (
      <div className="min-h-screen bg-[#0b1626] flex items-center justify-center">
        <div className="text-center">
          <Loader2 className="h-12 w-12 text-[#ee2737] animate-spin mx-auto mb-4" />
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-[#ee2737]/5 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2"></div>
      ...
      <div className="max-w-md w-full space-y-8 relative z-10">
        ...
        >
          <button
            ...
            className="inline-flex items-center text-gray-500 hover:text-[#ee2737] transition-colors mb-8 font-semibold text-sm group"
          >
          ...
          <div className="bg-white rounded-3xl shadow-sm border border-gray-100 w-20 h-20 flex items-center justify-center mx-auto mb-6">
            <Lock className="w-10 h-10 text-[#ee2737]" />
          </div>
        ...
        >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="block w-full pl-12 pr-12 py-3.5 border border-gray-200 rounded-xl bg-gray-50 focus:bg-white text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#ee2737]/20 focus:border-[#ee2737] transition-all"
                  ...
                  >
                    {showPassword ? (
                      <EyeOff className="h-5 w-5 text-gray-400 hover:text-[#ee2737]" />
                    ) : (
                      <Eye className="h-5 w-5 text-gray-400 hover:text-[#ee2737]" />
                    )}
                  </button>
                </div>
              </div>
              ...
              {message.text && (
                <div className={`p-4 rounded-xl flex items-start gap-3 animate-in fade-in slide-in-from-top-2 ${message.type === 'error'
                  ? 'bg-[#fde8ea] border border-[#ee2737]/30 text-[#d11f2d]'
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full flex justify-center items-center py-4 px-4 border border-transparent rounded-xl shadow-lg text-sm font-bold text-white bg-[#0b1626] hover:bg-[#1a2b4a] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#ee2737] disabled:opacity-50 disabled:cursor-not-allowed transition-all active:scale-[0.98] shadow-black/10"
              >
                {isLoading ? (
          ...
          {step === 'success' && (
            <div className="text-center space-y-8 py-4">
              ...
              <Link
                href="/login"
                className="w-full flex justify-center py-4 px-4 border border-transparent rounded-xl shadow-lg text-sm font-bold text-white bg-[#ee2737] hover:bg-[#d11f2d] transition-all active:scale-[0.98] shadow-[#ee2737]/20"
              >
          ...
          {step === 'error' && (
            <div className="text-center space-y-8 py-4">
              <div className="bg-[#fde8ea] rounded-3xl w-24 h-24 flex items-center justify-center mx-auto border border-[#ee2737]/20">
                <AlertCircle className="w-12 h-12 text-[#ee2737]" />
              </div>
              ...
              <div className="space-y-4">
                ...
                <Link
                  href="/login"
                  className="block text-sm font-bold text-[#ee2737] hover:text-[#d11f2d] transition-colors"
                >
                  Return to Login
                </Link>
              </div>
