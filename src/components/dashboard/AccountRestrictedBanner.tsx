        ...
        >
            <div className="max-w-7xl mx-auto px-4 py-3 mobile:px-8 mobile:py-4 flex flex-col mobile:flex-row items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-3">
                    <button
                        onClick={onPayFee}
                        className="bg-white text-amber-600 px-6 py-2 rounded-full text-[10px] mobile:text-[11px] font-black uppercase tracking-widest shadow-xl shadow-black/10 hover:bg-navy-900 hover:text-primary-500 transition-all flex items-center gap-2 group"
                    >
