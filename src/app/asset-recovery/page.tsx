...
const categories = [
    {
        ...
        description: 'Tracing lost, stolen, or fraudulently transferred digital assets across Bitcoin, Ethereum, and emerging chain networks — AML/CTF compliant.',
        redBorder: true,
    },
    {
        number: '02',
        title: 'Forex & Investment Fraud',
        description: 'Recovering capital lost to unlicensed brokers, clone firms, and false trading platforms targeting investors worldwide via social media.',
        redBorder: false,
    },
    {
        number: '03',
        title: 'Romance & Social Engineering',
        description: 'Identifying perpetrators and recovering funds extracted through emotionally manipulative schemes, pig-butchering, and trust-based fraud networks targeting victims globally.',
        redBorder: false,
    },
    {
        number: '04',
        title: 'Phishing & Bank Hacks',
        description: 'Rapid response to unauthorised account access, credential compromise, and fraudulent wire transfers through coordinated bank-level intervention under international banking regulations.',
        redBorder: true,
    },
];
...
const trustItems = ['24/7 Global Response Network', 'Internationally Compliant', 'Certified Forensic Team'];
