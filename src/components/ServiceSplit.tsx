            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-16">
                    <h2 className="text-3xl md:text-5xl font-bold text-navy-900 font-playfair mb-6">
                        Two Powerful Services, <span className="text-primary-600">One Secure Platform</span>
                    </h2>
                    <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                        Whether you need to recover lost funds or protect your current wealth, Nexus provides the legal and financial infrastructure you need.
                    </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
                    ...
                    <div className="group relative bg-white rounded-3xl shadow-xl overflow-hidden border border-gray-100 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
                        ...
                        <div className="p-10 lg:p-14">
                            ...
                            <Link href="/asset-recovery/report" className="inline-flex items-center gap-2 text-navy-700 font-bold hover:text-primary-600 hover:gap-3 transition-all">
                        ...
                        <div className="p-10 lg:p-14 text-white">
                            ...
                            <ul className="space-y-4 mb-10 text-gray-300">
                                <li className="flex items-center gap-3">
                                    ...
                                    <span>APRA Regulated Deposits</span>
                                </li>
                                <li className="flex items-center gap-3">
                                    <div className="w-1.5 h-1.5 rounded-full bg-navy-400"></div>
                            ...
                            <Link href="/signup" className="inline-flex items-center gap-2 text-white font-bold hover:text-primary-400 hover:gap-3 transition-all">
