            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-8">
              {paginatedPlans.map((plan, index) => (
                <motion.div
                  ...
                  className={`relative bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 cursor-pointer ${selectedPlan?._id === plan._id ? 'ring-2 ring-[#ee2737] border-[#ee2737]' : ''
                    }`}
                  ...
                  <div className="p-6">
                    ...
                    <button
                      className={`w-full mt-6 py-3 px-4 rounded-lg font-semibold transition-all duration-200 ${selectedPlan?._id === plan._id
                        ? 'bg-[#ee2737] text-white hover:bg-[#d11f2d]'
          ...
          <div className="mt-8 bg-white rounded-lg shadow-lg p-6">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                />
                {amountError && (
                  <p className="mt-2 text-sm text-[#ee2737]">{amountError}</p>
                )}
              </div>
              ...
              <button
                ...
                className="w-full bg-gradient-to-r from-[#ee2737] to-[#d11f2d] hover:from-[#d11f2d] hover:to-[#d11f2d] text-white py-3 px-6 rounded-lg font-semibold transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
              >
              ...
              {/* Message */}
              {message.text && (
                <div className={`p-4 rounded-lg ${message.type === 'success' ? 'bg-green-50 text-green-800' : 'bg-[#fde8ea] text-[#d11f2d]'
                  }`}>
                  {message.text}
                </div>
              )}
