  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        ...
        >
          <Loader2 className="w-12 h-12 text-[#ee2737] animate-spin mx-auto mb-4" />
        ...
        >
          ...
          <div className="space-y-3">
            <button
              ...
              className="w-full bg-[#ee2737] hover:bg-[#d11f2d] text-white py-3 px-6 rounded-lg font-semibold transition-colors duration-200"
            >
