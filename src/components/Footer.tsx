    ...
    <footer className="bg-navy-900 text-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 mobile:py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-base mobile:text-lg font-semibold mb-4 mobile:mb-6 text-primary-500 font-playfair">Services & Support</h3>
              ...
              {links.map((link) => (
                <li key={link.name}>
                  <Link href={link.href} className="text-gray-400 hover:text-white hover:translate-x-1 inline-block transition-all duration-200 flex items-center gap-2">
                    <span className="w-1 h-1 bg-primary-500 rounded-full opacity-0 hover:opacity-100 transition-opacity"></span>
                    {link.name}
                  </Link>
                </li>
              ))}
          ...
          {/* Contact Info */}
          <div>
            <h3 className="text-base mobile:text-lg font-semibold mb-4 mobile:mb-6 text-primary-500 font-playfair">Legal Contact</h3>
            <div className="space-y-4">
              <div className="flex items-start space-x-3 group">
                <Mail size={18} className="text-primary-500 mt-1 flex-shrink-0 group-hover:text-white transition-colors" />
                <div>
                  <p className="text-xs text-gray-500 uppercase tracking-wider">Direct Intake</p>
                  <span className="text-gray-300 group-hover:text-white transition-colors lowercase">admin@nexusbanking.com.au</span>
                </div>
              </div>
              <div className="flex items-start space-x-3 group">
                <Phone size={18} className="text-primary-500 mt-1 flex-shrink-0 group-hover:text-white transition-colors" />
                <div>
                  <p className="text-xs text-gray-500 uppercase tracking-wider">Global Switchboard</p>
                  <a href="tel:+61 2 8310 6000" className="text-gray-300 group-hover:text-white transition-colors hover:underline">+1 (409) 334-2911</a>
                </div>
              </div>
              <div className="flex items-start space-x-3 group">
                <Shield size={18} className="text-primary-500 mt-1 flex-shrink-0 group-hover:text-white transition-colors" />
                <div>
        ...
        <div className="border-t border-navy-800 mt-10 mobile:mt-12 pt-6 mobile:pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center text-center md:text-left gap-4">
            <p className="text-gray-500 text-sm">
              © {currentYear} Nexus Banking. Authorized Financial Institution & Legal Representative.
            </p>
            <div className="flex flex-wrap justify-center gap-6">
              <Link href="/privacy" className="text-gray-500 hover:text-primary-500 text-sm transition-colors">
                Privacy Policy
              </Link>
