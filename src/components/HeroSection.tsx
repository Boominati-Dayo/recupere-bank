...
const HeroSection = () => {
  ...
  return (
    <section className="relative bg-gradient-to-br from-gray-900 via-red-900 to-gray-900 text-white overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-r from-[#ee2737]/10 to-transparent"></div>
        ...
        <div className="grid grid-cols-1 mobile:grid-cols-2 gap-8 mobile:gap-12 items-center">
          ...
          >
                  ...
                  <AnimatePresence mode="wait">
                    ...
                    >
                      <DecryptedText
                        ...
                        animateOn="view"
                        className="text-red-400 bg-gradient-to-r from-red-400 via-[#ee2737] to-[#ee2737] bg-clip-text text-transparent"
            ...
            <div className="flex flex-col sm:flex-row gap-3 mobile:gap-4">
              <Link
                href="/signup"
                className="bg-[#ee2737] hover:bg-[#d11f2d] text-white px-6 py-3 mobile:px-8 mobile:py-4 rounded-lg text-base mobile:text-lg font-semibold transition-all duration-300 flex items-center justify-center group"
              >
                Get Started
