              ...
              <div className="space-y-6 pl-4">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:support@recuperebank.com" className="text-lg font-bold text-navy-900 hover:text-primary-500 transition-colors lowercase">support@recuperebank.com</a>
                  </div>
                </div>
