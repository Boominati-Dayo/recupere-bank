    ...
    <section className="py-12 mobile:py-20 lg:py-24 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="absolute top-0 right-0 w-96 h-96 bg-[#ee2737] rounded-full opacity-10 blur-3xl transform translate-x-32 -translate-y-32"></div>
          ...
          <div className="relative z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {steps.map((step, index) => (
                ...
                >
                  <div className="bg-gradient-to-br from-[#ee2737] to-[#d11f2d] w-12 h-12 mobile:w-16 mobile:h-16 rounded-xl mobile:rounded-2xl flex items-center justify-center text-xl mobile:text-2xl font-bold mx-auto mb-4 mobile:mb-6 shadow-lg transform rotate-3 hover:rotate-6 transition-transform">
                    {step.number}
                  </div>
