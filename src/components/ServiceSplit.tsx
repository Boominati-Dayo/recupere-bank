...
const services = [
  {
    ...
    desc: 'APRA-regulated private banking entirely online. Secure, compliant, and built for Australian high-net-worth individuals.',
    href: '/banking',
  },
  {
    num: '02',
    title: 'Commercial Property & Investment',
    desc: 'Access institutional-grade Australian property financing and structured investment vehicles for portfolio growth.',
    href: '/banking',
  },
  {
    num: '03',
    title: 'Nexus Safe Vault',
    desc: 'Encrypted digital vault for sensitive assets, documents, and high-value holdings with multi-layer authentication — Sydney-based security operations.',
    href: '/banking',
  },
  {
    num: '04',
    title: 'AUD & Multi-Currency Accounts',
    desc: 'Hold AUD and transact in 40+ currencies with competitive FX rates and real-time settlements via Australian clearing systems.',
    href: '/banking',
  },
  {
    num: '05',
    title: 'Wealth Management',
    desc: 'Australian-based advisors delivering bespoke investment strategies, estate planning, and long-term capital preservation.',
    href: '/contact',
  },
  {
    num: '06',
    title: 'Bank-Grade Cyber Security',
    desc: 'AES-256 encryption, biometric authentication, real-time fraud detection, and 24/7 threat monitoring from our SOC in Sydney.',
    href: '/banking',
  },
];
