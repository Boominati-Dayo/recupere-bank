...
const BankingHero = () => {
    return (
        <section className="relative min-h-[90vh] flex items-center pt-24 pb-12 overflow-hidden bg-navy-950">
            ...
            {/* Background Orbs */}
            <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-primary-600/10 rounded-full blur-[120px] -mr-64 -mt-32 z-1"></div>
            ...
            <div className="container mx-auto px-4 relative z-10">
                <div className="flex flex-col lg:flex-row items-center gap-16">
                    ...
                    <div className="lg:w-1/2 text-center lg:text-left">
                        ...
                        >
                            Secure Your <span className="text-primary-500 italic">Wealth</span>. <br />
                            Master Your <span className="underline decoration-primary-500/30 underline-offset-8">Future</span>.
                        </motion.h1>
                        ...
                        >
                            Experience a new standard in asset management. Nexus combines Swiss-level security with cutting-edge technology to protect and grow your capital globally.
                        </motion.p>
                        ...
                        >
                            <Link href="/signup" className="group relative w-full mobile:w-auto px-10 py-5 bg-primary-500 text-navy-950 rounded-2xl font-black text-sm uppercase tracking-widest overflow-hidden transition-all hover:shadow-[0_0_30px_rgba(191,155,48,0.4)] active:scale-95">
                    ...
                    <div className="lg:w-1/2 relative">
                        ...
                        >
                            <div className="relative z-20 bg-[#111827] border border-white/10 rounded-3xl p-6 mobile:p-10 shadow-2xl shadow-black/50 overflow-hidden">
                                ...
                                <div className="space-y-6">
                                    {[
                                        { label: 'Private Equity', val: '$840,000.00', pct: 65, color: 'bg-primary-500' },
                                ...
                                <div className="mt-12 flex items-center justify-between p-4 rounded-2xl bg-white/5 border border-white/5">
                                    ...
                                    <span className="text-[10px] font-black text-primary-500 uppercase tracking-widest text-right">Updated 2m ago</span>
                                </div>
                            </div>

                            {/* Decorative elements */}
                            <div className="absolute -top-10 -left-10 w-32 h-32 bg-primary-500/20 rounded-full blur-3xl -z-10"></div>
                        ...
                        <motion.div
                            ...
                            className="absolute -right-8 bottom-20 z-30 hidden mobile:block bg-primary-600 p-6 rounded-2xl shadow-xl shadow-primary-600/20 max-w-[200px]"
                        >
