                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mobile:gap-12 items-center">
                    ...
                    <div className="space-y-8 animate-fade-in-up">
                        ...
                        <h1 className="text-3xl mobile:text-5xl lg:text-7xl font-bold font-playfair text-white leading-tight">
                            Scammed? <br />
                            <span className="text-primary-500">We Fight Back.</span>
                        </h1>

                        <p className="text-base mobile:text-xl text-gray-300 max-w-lg leading-relaxed">
                            Banks often refuse to help. We don't. RecupereBank combines legal force with banking security to recover your lost funds from scams and unauthorised transactions.
                        </p>

                        <div className="flex flex-col sm:flex-row gap-3 mobile:gap-4 pt-4">
                            <Link href="/asset-recovery" className="bg-primary-500 hover:bg-primary-600 text-navy-900 px-6 py-3 mobile:px-8 mobile:py-4 rounded-lg font-bold text-base mobile:text-lg transition-all shadow-[0_0_20px_rgba(201,147,58,0.3)] hover:shadow-[0_0_30px_rgba(201,147,58,0.5)] flex items-center justify-center gap-2">
                                Start Recovery
                                <ArrowRight className="w-5 h-5" />
                            </Link>
                            <Link href="/banking" className="px-6 py-3 mobile:px-8 mobile:py-4 rounded-lg font-bold text-base mobile:text-lg text-white border-2 border-navy-600 hover:bg-navy-800 hover:border-primary-500/50 transition-all flex items-center justify-center">
                                Explore Banking
                            </Link>
                        </div>
                    ...
                    <div className="relative lg:ml-auto w-full max-w-md">
                        ...
                        <div className="bg-white rounded-2xl shadow-2xl p-6 mobile:p-8 relative z-20 border-[6px] mobile:border-[8px] border-navy-800/30">
                            <div className="absolute -top-10 -right-10 mobile:-top-12 mobile:-right-12 w-20 h-20 mobile:w-24 mobile:h-24 bg-primary-500 rounded-full flex items-center justify-center shadow-lg transform rotate-12 hidden md:flex">
                        ...
                        <div className="absolute -bottom-6 -right-6 w-full h-full bg-primary-500/20 rounded-2xl z-10"></div>
