                ...
                <div className="flex items-center space-x-2 md:space-x-4">
                  {[1, 2, 3, 4].map((step, index) => (
                    <div key={step} className="flex items-center">
                      <div className={`flex items-center justify-center w-8 h-8 rounded-full text-sm font-medium transition-colors ${currentStep === step ? 'bg-primary-500 text-navy-900 ring-4 ring-primary-500/20' :
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex space-x-3 pt-4">
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="flex-[2] flex justify-center items-center py-3 px-4 rounded-lg shadow-sm text-sm font-bold text-navy-900 bg-primary-500 hover:bg-primary-400 transition-colors disabled:opacity-70 disabled:cursor-not-allowed"
                >
                  {isLoading ? (
