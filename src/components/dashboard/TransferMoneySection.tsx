        ...
        {currentStep === 1 && (
          <div className="space-y-4 mobile:space-y-6">
            <div>
              ...
              <input
                type="email"
                className={`w-full px-4 py-2.5 mobile:py-3 border rounded-lg focus:ring-2 focus:ring-[#ee2737] focus:border-transparent text-sm mobile:text-base ${receiverValid ? 'border-green-300 bg-green-50' :
                  error && receiverEmail ? 'border-red-300 bg-[#fde8ea]' :
                    'border-gray-300'
                  }`}
            ...
            <div>
              ...
              <input
                type="text"
                className={`w-full px-4 py-2.5 mobile:py-3 border rounded-lg focus:ring-2 focus:ring-[#ee2737] focus:border-transparent transition-colors text-sm mobile:text-base ${receiverValid ? 'border-green-500 bg-green-50' :
                  validationError && receiverUserCode.length === 8 ? 'border-[#ee2737] bg-[#fde8ea]' :
              ...
              {validationError && (
                <p className="text-sm text-[#ee2737] mt-1">{validationError}</p>
              )}
              {receiverValid && (
            ...
            {error && (
              <div className="p-4 bg-[#fde8ea] border border-red-200 rounded-lg">
                <p className="text-[#d11f2d] text-sm">{error}</p>
              </div>
            )}
            ...
            <button
              ...
              className="w-full bg-[#0b1626] hover:bg-[#1a2b45] disabled:bg-gray-400 disabled:cursor-not-allowed text-primary-500 py-2.5 mobile:py-3 px-6 rounded-lg font-semibold transition-colors duration-200 flex items-center justify-center text-sm mobile:text-base border border-primary-500/20"
            >
            ...
            <form onSubmit={handleTransfer} className="space-y-4 mobile:space-y-6">
              ...
              <div className="flex space-x-3 mobile:space-x-4">
                ...
                <button
                  ...
                  className="flex-1 bg-[#0b1626] hover:bg-[#1a2b45] disabled:bg-gray-400 disabled:cursor-not-allowed text-primary-500 py-2.5 mobile:py-3 px-6 rounded-lg font-semibold transition-colors duration-200 flex items-center justify-center text-sm mobile:text-base border border-primary-500/20"
                >
                  {isTransferring ? (
                    <>
                      <svg className="animate-spin -ml-1 mr-2 h-4 w-4 mobile:h-5 mobile:w-5 text-primary-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
