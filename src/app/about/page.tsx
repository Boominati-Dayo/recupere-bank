        ...
        <section className="py-24 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div>
                <h2 className="text-sm font-bold tracking-widest text-primary-500 uppercase mb-3">The Origin</h2>
                <h3 className="text-4xl font-bold text-navy-900 mb-6">Built by Investigators.</h3>
                <p className="text-gray-600 text-lg leading-relaxed mb-6">
                  Nexus was founded when a group of ex-prosecutors and intelligence-grade forensic accountants realized a fundamental flaw in the financial system. When complex fraud occurs, traditional banks often reject liability, and local police lack the international jurisdiction to pursue the funds.
                </p>
        ...
        <section className="py-24 bg-navy-900 text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-sm font-bold tracking-widest text-primary-500 uppercase mb-3">Our Board</h2>
