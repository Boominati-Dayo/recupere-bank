            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
                    <div className="max-w-2xl">
                        <h2 className="text-sm font-bold tracking-widest text-primary-400 uppercase mb-3">Proven Results</h2>
                    ...
                    <button className="hidden text-primary-400 hover:text-primary-300 font-semibold items-center gap-2 group transition-colors">
                        View All Cases
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {cases.map((c, idx) => (
                        <div key={idx} className="bg-navy-800 border border-navy-700/50 p-8 rounded-xl hover:bg-navy-800/80 transition-colors">
                            <div className="inline-block px-3 py-1 bg-primary-400/10 text-primary-400 text-xs font-bold rounded-full mb-6 uppercase tracking-wider">
                                {c.type}
                            </div>
                            ...
                            <div className="flex gap-4 mb-6 pb-6 border-b border-navy-700">
                                <div>
                                    <div className="text-3xl font-bold text-primary-400">{c.amount}</div>
