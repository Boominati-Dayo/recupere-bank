...
const testimonialData: TestimonialData[] = [
  {
    ...
    description: 'User lost their life savings to a "Liquidity Mining" scam. Nexus traced the funds across three international exchanges, issued a legal freeze, and successfully repatriated $85,400 within 14 days.'
  },
  {
    image: Proof2,
  ...
  },
  {
    ...
    description: 'After a sophisticated phishing attack drained a client\'s safe vault, Nexus\'s forensic accountants provided incontrovertible evidence of illegal access, forcing the custodial platform to honor a full loss reimbursement.'
  },
  {
    image: Proof4,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-2 px-3 py-1 bg-primary-50 border border-primary-100 rounded-full mb-4">
            ...
            <span className="text-primary-600 font-black tracking-widest uppercase text-[10px]">Forensic Registry</span>
          </div>
        ...
        <div className="relative max-w-5xl mx-auto">
            ...
            >
              <div className="bg-white rounded-[3rem] overflow-hidden shadow-2xl border border-gray-100 flex flex-col md:flex-row min-h-[500px]">
                ...
                <div className="w-full md:w-2/5 p-8 mobile:p-12 flex flex-col justify-center bg-navy-900 text-white relative">
                  ...
                  <div className="w-12 h-12 bg-primary-500/20 rounded-2xl flex items-center justify-center text-primary-500 mb-8 border border-primary-500/20">
                    <ShieldCheck className="w-6 h-6" />
                  </div>

                  <div className="relative mb-8">
                    <Quote className="w-12 h-12 text-primary-500/10 absolute -top-12 -left-6" />
                    <h4 className="text-2xl font-black uppercase tracking-tighter text-white mb-2 leading-tight">
                      {current.title}
                    </h4>
                    <p className="text-primary-500 font-mono text-[10px] font-black tracking-widest uppercase mb-6 bg-primary-500/10 inline-block px-2 py-1 rounded">
                      {current.tag}
                    </p>
                    <div className="relative border-l-2 border-primary-500/40 pl-6 py-1">
          ...
          <div className="flex justify-center items-center gap-6 mt-12">
            <button 
              onClick={prev}
              className="w-12 h-12 bg-white rounded-full flex items-center justify-center text-navy-900 hover:bg-navy-900 hover:text-primary-500 transition-all border border-gray-100 shadow-lg active:scale-90 group"
            >
