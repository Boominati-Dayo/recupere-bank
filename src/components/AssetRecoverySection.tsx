            ...
            <div className="container mx-auto px-4 relative z-10">
                <div className="flex flex-col lg:flex-row items-center gap-16">
                    ...
                    <div className="lg:w-1/2 order-2 lg:order-1">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <motion.div
                                ...
                                className="hidden md:flex flex-col bg-primary-500 p-8 rounded-3xl text-navy-900 space-y-4 shadow-xl shadow-primary-500/10 text-right items-end md:text-left md:items-start"
                            >
                            ...
                            >
                                ...
                                >
                                    {/* Background Icon */}
                                    <ShieldCheck className="absolute -right-4 -top-4 w-56 h-56 text-primary-500/10 rotate-12 pointer-events-none" />
                                ...
                                <div
                                    className="bg-primary-500 p-8 pt-20 pb-12 text-navy-900 space-y-4 -mt-16 relative z-[-1] flex-1 flex flex-col justify-center items-end text-right overflow-hidden"
                                >
                                    {/* Background Icon */}
                    ...
                    <div className="lg:w-1/2 order-1 lg:order-2 text-center lg:text-left">
                        ...
                        >
                            Lost Assets? <br />
                            Secure Your <span className="text-primary-600 italic underline decoration-primary-500/20 underline-offset-8">Repatriation</span>.
                        </motion.h2>
                        ...
                        >
                            <Link href="/asset-recovery/report" className="w-full mobile:w-auto px-10 py-5 bg-navy-900 text-primary-500 rounded-2xl font-black text-sm uppercase tracking-widest flex items-center justify-center gap-3 hover:bg-navy-800 transition-all shadow-xl shadow-navy-900/20 active:scale-95">
