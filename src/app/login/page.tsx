            ...
            {!showForgotPassword ? (
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="w-full flex justify-center items-center py-3 px-4 border border-transparent rounded-lg shadow-sm text-sm font-medium text-white bg-navy-600 hover:bg-navy-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {isLoading ? (
                ...
                {forgotPasswordSuccess ? (
                  <div className="text-center space-y-4">
                    ...
                    <button
                      ...
                      className="w-full py-2 px-4 border border-transparent rounded-lg text-sm font-medium text-white bg-navy-600 hover:bg-navy-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500"
                    >
                      Back to Login
                    </button>
                  </div>
                  ...
                  <form onSubmit={handleForgotPassword} className="space-y-6">
                    ...
                    <div className="flex space-x-3">
                      <button
                        ...
                        className="flex-1 py-2 px-4 border border-gray-300 rounded-lg text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500"
                      >
                        Back
                      </button>
                      <button
                        ...
                        className="flex-1 py-2 px-4 border border-transparent rounded-lg text-sm font-medium text-white bg-navy-600 hover:bg-navy-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 disabled:opacity-50"
                      >
            ...
            <div className="mt-6 text-center">
              <p className="text-gray-600">
                ...
                <button
                  ...
                  className="text-primary-600 hover:text-primary-500 font-bold"
                >
                  Open an Account
                </button>
              </p>
