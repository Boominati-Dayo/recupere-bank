          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="text-center mb-10 mobile:mb-16">
              ...
              <button
                ...
                className="mt-4 text-[#ee2737] hover:text-[#d11f2d] font-medium"
              >
          ...
          <div className="flex items-center justify-center gap-3 mobile:gap-4 mb-2 mobile:mb-4">
            ...
            {user && (
              <button
                ...
                disabled={refreshing}
                className="p-2 rounded-lg bg-[#ee2737] text-white hover:bg-[#d11f2d] disabled:opacity-50 transition-colors"
                title="Refresh plans"
              >
          ...
          <div className="relative">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-8">
              {paginatedPlans.map((plan, index) => (
                <motion.div
                  ...
                  className={`relative bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 ${selectedPlan?._id === plan._id ? 'ring-2 ring-[#ee2737] border-[#ee2737]' : ''
                    }`}
                >
            ...
            {totalPages > 1 && (
              <div className="flex items-center justify-center space-x-4 mt-8">
                ...
                <button
                  onClick={prevPage}
                  className="p-2 rounded-full bg-white shadow-md hover:shadow-lg transition-all duration-200 hover:bg-[#fde8ea]"
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-[#ee2737] focus:border-transparent ${amountError ? 'border-[#ee2737]' : 'border-gray-300'
                      }`}
              ...
              <div className="bg-gray-50 rounded-lg p-6">
                ...
                {investmentAmount > 0 ? (
                  <div className="space-y-3">
                    ...
                    <div className="flex justify-between">
                      <span className="text-gray-600">Capital Back:</span>
                      <span className={`font-semibold ${selectedPlan.capitalBack ? 'text-green-600' : 'text-[#ee2737]'}`}>
                ...
                <div className="text-center">
                  <button
                    className={`py-3 px-8 rounded-lg font-semibold transition-colors duration-200 ${isProcessing || investmentAmount === 0 || amountError || investmentAmount > accountBalance
                      ...
                      : 'bg-[#ee2737] hover:bg-[#d11f2d] text-white'
                      }`}
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 mt-8">
            ...
            {message.text && (
              <div className={`p-4 rounded-lg mb-6 ${message.type === 'success'
                ...
                : 'bg-[#fde8ea] border border-red-200 text-[#d11f2d]'
                }`}>
                {message.text}
              </div>
            )}
