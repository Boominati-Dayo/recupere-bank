        ...
        <PublicRoute>
            <div className="min-h-screen bg-gray-50">
                ...
                <section className="bg-navy-900 text-white pt-32 pb-24 relative overflow-hidden">
                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                            <div>
                                <h2 className="text-primary-500 font-bold tracking-widest uppercase mb-4 text-sm">Welcome to Nexus Finance</h2>
                            ...
                            <div className="hidden lg:block relative h-[600px] w-full rounded-2xl overflow-hidden shadow-2xl border border-white/10">
                                <Image src={BankingAppImg} alt="Nexus Digital Banking App" fill className="object-cover" />
                ...
                <section className="py-24 bg-white relative">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="text-center mb-16">
                            <h2 className="text-sm font-bold tracking-widest text-primary-500 uppercase mb-3">Institutional Grade</h2>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                            {features.map((feature, index) => (
                                <div key={index} className="bg-gray-50 p-10 rounded-xl shadow-sm border border-gray-100 hover:shadow-lg hover:border-primary-500/30 transition-all group">
                ...
                <section className="py-24 bg-gray-50 border-t border-gray-100">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="text-center mb-16">
                            <h2 className="text-sm font-bold tracking-widest text-primary-500 uppercase mb-3">Customized Financial Solutions</h2>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                            {[
                                ...
                                <div key={i} className="bg-white border border-gray-200 rounded-xl p-6 hover:shadow-md hover:border-primary-300 transition-all">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                            ...
                            <div>
                                ...
                                <p className="text-gray-300 text-lg mb-6 leading-relaxed">
                                    Unlike traditional banks that turn away fraud victims, Nexus was built to solve this exact problem. We operate specialized legal departments internally to pursue lost funds.
                                </p>
                                ...
                                <Link
                                    href="/asset-recovery"
                                    className="inline-flex items-center gap-2 text-primary-500 hover:text-primary-400 font-bold text-lg"
                                >
