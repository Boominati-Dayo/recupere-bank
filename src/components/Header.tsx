              ...
              return (
                <Link
                  ...
                  className={`px-3 py-2 text-sm font-semibold transition-all duration-200 ${isActive
                    ? 'text-navy-700 border-b-2 border-primary-500'
          ...
          <div className="hidden mobile:flex items-center space-x-4">
            {user ? (
              <>
                <Link
                  href="/dashboard"
                  className="text-navy-700 hover:text-primary-600 px-3 py-2 rounded-lg hover:bg-navy-50 transition-colors duration-200 text-sm font-medium"
                >
                  Dashboard
                </Link>
                ...
                <div className="relative" ref={userMenuRef}>
                  ...
                  >
                    <div className="w-9 h-9 bg-navy-700 rounded-full flex items-center justify-center text-white font-semibold text-sm border-2 border-primary-400">
                  ...
                  {showUserMenu && (
                    <div className="absolute right-0 mt-2 w-56 bg-white rounded-lg shadow-xl border border-gray-100 py-2 z-50">
                      ...
                      <button
                        ...
                        className="flex items-center space-x-2 px-4 py-3 text-sm text-[#ee2737] hover:bg-[#fde8ea] w-full text-left"
                      >
              ...
              <>
                ...
                <Link
                  href="/signup"
                  className="bg-navy-700 hover:bg-navy-800 text-white px-5 py-2.5 rounded-md text-sm font-semibold transition-all duration-200 shadow-md hover:shadow-lg border border-transparent hover:border-primary-500/30"
                >
                  Open Account
                </Link>
              </>
          ...
          {!loading && (
            <div className="mobile:hidden">
              <button
                ...
                className="text-navy-700 hover:text-primary-600 p-2"
              >
                ...
                return (
                  <Link
                    ...
                    className={`block px-4 py-3 text-base font-medium rounded-md transition-colors duration-200 ${isActive
                      ? 'text-navy-800 bg-navy-50 border-l-4 border-primary-500'
                  ...
                  <div className="space-y-3 px-2">
                    <div className="px-3 py-3 bg-navy-50 rounded-lg border border-navy-100">
                      <div className="flex items-center space-x-3">
                        <div className="w-10 h-10 bg-navy-700 rounded-full flex items-center justify-center text-white font-semibold border border-primary-400">
                          {userProfile?.firstName?.[0] || user.email?.[0]?.toUpperCase()}
                        </div>
                        <div>
                          <p className="text-sm font-bold text-navy-900">
                    ...
                    <button
                      ...
                      className="flex items-center space-x-2 px-4 py-3 text-[#ee2737] hover:bg-[#fde8ea] rounded-lg text-base font-medium w-full text-left"
                    >
        ...
        <div className="fixed inset-0 bg-navy-900/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-xl shadow-2xl p-6 max-w-md w-full mx-4 border border-navy-100">
            <div className="flex items-center space-x-4 mb-5">
              <div className="w-12 h-12 bg-[#fde8ea] rounded-full flex items-center justify-center">
                <Shield className="w-6 h-6 text-[#ee2737]" />
              </div>
              <div>
